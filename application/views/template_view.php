        ...
        <div class="main_container">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="<?php echo base_url() ?>assets/images/upload/profile/<?php echo $this->db->where('USERNAME', $this->session->userdata('username'))->get('admin')->row('PHOTO') ?>" style="height: 56px; width: 50px" class="img-circle profile_img">
                        </div>
            ...
            <footer>
                <div class="pull-right">
                    Perpustakaan | Copyright By Kelompok 3
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
